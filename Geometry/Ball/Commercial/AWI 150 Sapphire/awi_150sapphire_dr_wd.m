...
load awi_150sapphire_dr_wd

dr = awi_150sapphire_dr_wd(:,9);
wd = awi_150sapphire_dr_wd(:,7);
base_rays = awi_150sapphire_dr_wd(:,10);
n_rays = awi_150sapphire_dr_wd(:,11);
base_rays_area = awi_150sapphire_dr_wd(:,12);
n_rays_area = awi_150sapphire_dr_wd(:,13);
diff_improvement = awi_150sapphire_dr_wd(:,14);
diff_improvement_area = awi_150sapphire_dr_wd(:,15);
