...
load('awi_150sapphire_dr_wd_fresnel.mat')

dr = avi_150sapphire_dr_wd_fresnel(:,9);
wd = avi_150sapphire_dr_wd_fresnel(:,7);
base_rays = avi_150sapphire_dr_wd_fresnel(:,10);
n_rays =avi_150sapphire_dr_wd_fresnel(:,11);
base_rays_area = avi_150sapphire_dr_wd_fresnel(:,14);
n_rays_area = avi_150sapphire_dr_wd_fresnel(:,15);
diff_improvement = avi_150sapphire_dr_wd_fresnel(:,16);
diff_improvement_area = avi_150sapphire_dr_wd_fresnel(:,17);
